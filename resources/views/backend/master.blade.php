...
<body>
<script src="{{url('js/monetization.js')}}" type="text/javascript"></script>
<script>
(function(){
...
<body><link rel="stylesheet" href="{{url('css/font-awesome.min.css')}}">
<!-- New toolbar-->
<style>
* {
...
<div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">
    ...
    <div id="w3lDemoBar" class="w3l-demo-bar">
        <div class="demo-btns">
        <a href="https://w3layouts.com/?p=42015">
        ...
        <a href="https://w3layouts.com/checkout/?add-to-cart=42015" class="no-margin-bottom-mobile">
...
<div class="chart-layer-2">
	...
	<div class="col-md-6 chart-layer2-right">
	        ...
	        <div class='bar_group'>
				...
				<script src="{{url('js/bars.js')}}"></script>
