...
<div class="container">
    <div class="py-5 text-center">
        <h2>Medicine Shop</h2>
        <p class="lead">We are trying to improve our services to serve you more better. Thank you for you trust on us.</p>
    </div>
    {{-- geting products --}}
    @php
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        ...
                        <small class="text-muted">{{$cart['price']}}X{{$cart['quantity']}}</small>
                    </div>
