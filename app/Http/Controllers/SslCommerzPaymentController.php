...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['cus_email'] =$request->input('customer_mobile') ;
        ...
        $post_data['cus_phone'] =$request->input('customer_email') ;
        $post_data['cus_fax'] = "";
    ...
    public function success(Request $request)
    {
        ...
        ->select('id','transaction_id','user_id','Subtotal','status')->first();
        // dd($order_detials);
        if ($order_detials->status == 'pending') {
            ...
            if ($validation == TRUE) {
                ...
                */
                $update_product = Order::where('transaction_id', $tran_id)->update([
                    'status' => 'processing',
                ]);
